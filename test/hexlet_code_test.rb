...
class TestHexletCode < Minitest::Test
  ...
  def test_empty_form_with_default_attributes
    user = User.new
  ...
  def test_empty_form_with_attributes
    user = User.new
  ...
  def test_form_with_input_as_text
    user = User.new name: 'rob', job: 'hexlet'
  ...
  def test_form_with_empty_inputs
    user = User.new
  ...
  def test_form_with_submit_specific_value
    user = User.new
  ...
  def test_error_when_unexpected_input_name
    user = User.new
